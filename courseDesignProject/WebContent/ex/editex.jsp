	...
	<table class="easyui-datagrid" toolbar="#toolbar"
		...
		<tbody>
			<%
				...
				String strSql = "select DATE_FORMAT(出库时间,'%Y-%m-%d %H:%i:%S')as timeex,出库备件编码,出库单号,入库单号,备件名称,出库数量,出库单价,库位,经办人,备注 from expart,spare_parts where expart.出库备件编码=spare_parts.备件编码 order by timeex desc";
			...
			<tr>
				...
				<td><div align="center">
						<a href="/courseDesignProject/deletexservlet?exnum=<%=exnumstr%>&qun=<%=qunstr%>&code=<%=codestr%>">删除</a>
					</div></td>
