...
<body >
	...
	response.setContentType( "text/html; charset=utf-8");	 
 	String restr = new String(request.getParameter("re").getBytes("ISO-8859-1"),"utf-8");
	...
	<div id="dlg" class="easyui-dialog" title="登录错误提示" data-options="iconCls:'icon-save'" style="width:300px;height:150px;padding:10px">
		<div align="center" font-family="微软雅黑";font-size=40px;><%=restr%></div>
	</div>
