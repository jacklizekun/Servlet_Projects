...
/**
 * Servlet implementation class searchexservlt
 */
@WebServlet("/searchexservlt")
public class searchexservlt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchexservlt() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("/courseDesignProject/ex/searchex.jsp?starttime=" + java.net.URLEncoder.encode(starttimestr,"UTF-8")+"&endtime="+ java.net.URLEncoder.encode(endtimestr,"UTF-8"));
	}
