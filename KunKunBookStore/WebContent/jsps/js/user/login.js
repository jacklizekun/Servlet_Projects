$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/KunKunBookStore/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/KunKunBookStore/images/login1.jpg");
		}
	);
	
	// 给注册按钮添加submit()事件，完成表单校验
...
function validateVerifyCode() {
	...
	if(!value) {//非空校验
		...
		$.ajax({
			...
			url: "/KunKunBookStore/UserServlet",
