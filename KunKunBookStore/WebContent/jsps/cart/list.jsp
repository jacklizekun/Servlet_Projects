	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/KunKunBookStore/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function sendUpdateQuantity(id, quantity) {
	$.ajax({
		async:false,
		cache:false,
		url:"/KunKunBookStore/CartItemServlet",
...
function batchDelete() {
	...
	location = "/KunKunBookStore/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
