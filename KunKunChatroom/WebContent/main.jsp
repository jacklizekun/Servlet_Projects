...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎来到坤坤聊天室，我的地盘我做主</span><br><span style='line-height:22px;'>";
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎来到坤坤聊天室，我的地盘我做主</span><br><span style='line-height:22px;'>";
	//间隔1秒一检查
	window.setInterval("showContent();",1000);
	window.setInterval("showOnLine();",10000);
	window.setInterval("check();",1000);
	//页面不停执行检查是否在线和发言、是否踢下线
	$(function(){
		showOnLine();
		showContent();
		check();
...
<body>
	...
	<table width="778" height="276" border="0" align="center"
		...
		<tr>
			<td width="165" valign="top" bgcolor="#f6fded" id="online" style="padding:5px">当前在线人员列表</td>
