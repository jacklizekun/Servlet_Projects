 ...
 <div class="form-group">
  ...
  <div class="form-group">
	...
	<div style="margin-top:50px;">
			<img src="${pageContext.request.contextPath}/img/footer.jpg" width="100%" height="78" alt="坤坤的优势" title="坤坤的优势" />
		</div>

		<div style="text-align: center;margin-top: 5px;">
			<ul class="list-inline">
				<li><a href="${pageContext.request.contextPath}/jsp/info.jsp">坤坤商城</a></li>
				<li><a>物美价廉</a></li>
				<li><a>欢迎光临</a></li>
				<li><a>配送方便</a></li>
				<li><a>售后便利</a></li>
